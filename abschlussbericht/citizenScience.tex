...
Die Dateneingabe erfolgt bei TIMA im einfachsten Fall entweder über die Webseite oder die bereits entstanden App. Dabei werden nacheinander, dem Nutzer, Wörter gegeben, zu denen er eine Assoziation eingeben soll. Der dabei gewählte Algorithmus zur Wortauswahl wird im nächsten Abschnitt beschrieben.
...
Falls ein Nutzer zu einem Wort keine Assoziation einfällt, hat er die
...
Rechtschreibkontrolle. Wo bei nur auf Korrektheit eines Wortes geachtet wird und dem Nutzer keine Vorschläge zur Rechtschreibung gemacht werden.
